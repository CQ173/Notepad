...
public class HomeFragAdapter extends RecyclerBaseAdapter<WholeInfoRes> {



    public HomeFragAdapter(@NonNull Context context, @NonNull List<WholeInfoRes> wholeInfoRes ) {
